...
> Strategic guidelines and procedures for the Seo Fundamentals capability in this repository.
...
|--------|---------|---------|
| `scripts/seo_checker.py` | Python SEO validation utility | `python scripts/seo_checker.py` |
