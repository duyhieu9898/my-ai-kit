...
description: Use when analyzing large projects (500+ files), computing blast radius
  of commits/PRs, re-indexing AST databases, or diagnosing high token costs. Token-efficient
