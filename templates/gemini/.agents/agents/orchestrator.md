...
model: inherit
skills: parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, bash-linux, coordinator-mode, memory-system, context-compression, verify-changes
---
