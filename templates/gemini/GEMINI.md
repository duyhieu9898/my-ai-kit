...
| **SLASH CMD**    | /create, /debug                            | Command-specific flow          | Variable                    |
...
| 2 | Did I READ the agent's `.md` file (or recall its rules)? | -> STOP. Open `.agents/agents/{agent}.md` |
...
1. Check `.agents/ARCHITECTURE.md` -> File Dependencies
