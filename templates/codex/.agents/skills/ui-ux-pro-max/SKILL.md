...
**Windows:**
```bash
powershell -Command "winget install Python.Python.3.12"
```
...
When the user requests UI/UX work (design, build, create, implement, review, fix, improve), load and execute this skill:
