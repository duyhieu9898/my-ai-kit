...
description: Use when changing multiple files with the same pattern, renaming across
  a codebase, adding imports or headers to many files, or performing bulk migrations.
  Applies operations across multiple files simultaneously using pattern-based bulk
